...
<head>
    ...
    <!-- 引入加密js -->
    <script src="${ctx}/res/thirdParty/jquery.base64.js"></script>
    <script src="${ctx}/res/resource/style/js/function.js"></script>
...
<script>
	...
	$(function(){
		...
		var orgSetting = {
				...
				async: {
					enable: true,
					 url: "${ctx}/backstage/website/work-flow-define!parseOrganization.json",
					autoParam:["id"]
				}
			};
		var userSetting = {
				...
				async: {
					enable: true,
					 url:"${ctx}/backstage/website/work-flow-define!parseUser.json",
					autoParam:["id"]
				}
			};
		...
		var roleSetting = {
				...
				async: {
					enable: true,
					 url:"${ctx}/backstage/website/work-flow-define!parseRole.json",
					autoParam:["id"]
				}
			};
		$.fn.zTree.init($("#orgView"), orgSetting);
		$.fn.zTree.init($("#userView"), userSetting);
		$.fn.zTree.init($("#roleView"), roleSetting);
	...
	<div id="dailog_participant" title="参与者" style="height:325px;display:none;">
		<div style="height:180px;float:left">
			<table class="f_table">
				...
				<tr>
					<td><input name="gs_operator" id="gs_role" type="radio"/><label for="gs_role">指定角色</label></td>
				</tr>
				<tr>
		...
		<div id="roleViewDiv" style="display:none;float:left;background: #EBF0A8">
			<table class="f_table">
				<tr height="310px"><td>
					<div class="f_box" style="height:310px;width:240px;overflow:auto">
						<div id="roleView" class="ztree"></div>
					</div>
				</td></tr>
			</table>
		</div>
